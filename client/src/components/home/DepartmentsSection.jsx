    ...
    <section className="departments-section">
      <div className="departments-inner">
        ...
        <div className="departments-top">
          <div className="departments-heading">
            ...
            <h2>
              ...
              <span>One Production</span>
              <span>Standard.</span>
            </h2>

            <p className="departments-intro">
              Our production process brings key manufacturing stages
              together to maintain consistency from product development
              through finishing and final packing.
            </p>
        ...
        <div className="departments-footer">
          <p>
            From initial development to final quality inspection,
            every stage is focused on producing reliable custom
            apparel for brands, teams and businesses.
          </p>
